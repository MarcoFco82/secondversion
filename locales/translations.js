export const translations = {
  en: {
    ...
    // Password Modal
    passwordModal: {
      title: "Access Professional Experience",
      description: "Enter the password to view professional details:",
  ...
  es: {
    ...
    experience: [
      ...
      {
        id: 8,
        company: "Sicom TV, Televisión del Estado de Puebla",
        location: "Puebla, Angelópolis",
        bullets: [
    ...
    // Password Modal
    passwordModal: {
      title: "Acceso a Experiencia Profesional",
      description: "Ingresa la contraseña para ver los detalles profesionales:",
      placeholder: "Ingresa contraseña",
      errorMessage: "Contraseña incorrecta. Por favor intenta de nuevo.",
      submitBtn: "DESBLOQUEAR"
    },
